...
class NEBDB:
    def __init__(self, table_name="neb_db_devraj_final_new", user_log="user_log"):
    ...
    def update_with_log(self, row, updated_row, user_id=555, merged_or_not=0):
        """
        ...
        if existing:
            ...
            INSERT INTO {self.user_log} (
                ...
                TOTAL, RESULT, REMARKS, BookName, ImageName, QC_CHECK, QC_REMARKS, FILE_PATH,
                ...
                old_TOTAL, old_RESULT, old_REMARKS, old_BookName, old_ImageName, old_QC_CHECK, old_QC_REMARKS, old_FILE_PATH
            ) VALUES (
                ...
                %(TOTAL)s, %(RESULT)s, %(REMARKS)s, %(BookName)s, %(ImageName)s, %(QC_CHECK)s, %(QC_REMARKS)s, %(FILE_PATH)s,
                ...
                %(old_TOTAL)s, %(old_RESULT)s, %(old_REMARKS)s, %(old_BookName)s, %(old_ImageName)s, %(old_QC_CHECK)s, %(old_QC_REMARKS)s, %(old_FILE_PATH)s
            )
            """
